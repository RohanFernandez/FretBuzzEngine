...
namespace ns_fretBuzz
{
	...
	void Inspector::render(SceneManager& a_SceneManager)
	{
		...
		bool l_bIsPaused = System::IsSystemPaused();
		ImGui::Checkbox("Pause", &l_bIsPaused);
		System::ToggleSystemPause(l_bIsPaused);

		ImGui::Separator();

		/*float l_fCurentScaledTime = System::GetScaledTime();
		ImGui::SliderFloat("Scale Time", &l_fCurentScaledTime, 0.0f, 1.0f);
		System::SetScaledTime(l_fCurentScaledTime);*/
