...
namespace ns_fretBuzz
{
	...
	class GameObject;
	class  Model : public IManagedResource
	{
	private:
		...
		static void addMeshToGameObject(GameObject& a_GameObject, Node& a_Node);
	...
	public:
		...
		static void addToGameObject(GameObject& a_GameObject, Model& a_Model);
