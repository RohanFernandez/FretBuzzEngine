...
namespace ns_HMGame
{
		...
		ns_fretBuzz::ns_system::IScene(a_strSceneName)
	{
		...
		ns_fretBuzz::ns_graphics::Camera::addToGameObject(*m_pCam, ns_fretBuzz::ns_graphics::Viewport::PROJECTION_TYPE::ORTHOGRAPHIC, &l_CamViewport);
		...
		ns_fretBuzz::ns_system::Behaviour::addToGameObject<PlayerController>(*m_pPlayerGameObject, m_pCam);
	}
}