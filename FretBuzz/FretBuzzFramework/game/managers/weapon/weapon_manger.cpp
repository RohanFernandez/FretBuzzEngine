...
namespace ns_HMGame
{
		...
		m_WeaponPool()
	{
		...
		m_WeaponMap.insert({ WEAPON_TYPE::WEAPON_M16,			WeaponData(WeaponData::WEAPON_ATTACK_TYPE::GUN,	  WEAPON_TYPE::WEAPON_M16,			"m16idle"				, "weapon_pickup|weapon_M16") });
		m_WeaponMap.insert({ WEAPON_TYPE::WEAPON_SHOTGUN,		WeaponData(WeaponData::WEAPON_ATTACK_TYPE::GUN,	  WEAPON_TYPE::WEAPON_SHOTGUN,		""						, "weapon_pickup|weapon_shotgun") });
		m_WeaponMap.insert({ WEAPON_TYPE::WEAPON_DOUBLE_BARREL, WeaponData(WeaponData::WEAPON_ATTACK_TYPE::GUN,   WEAPON_TYPE::WEAPON_DOUBLE_BARREL,  "doublebarrelidle"	, "weapon_pickup|weapon_doublebarrel") });
		...
		m_WeaponMap.insert({ WEAPON_TYPE::WEAPON_MAGNUM,		WeaponData(WeaponData::WEAPON_ATTACK_TYPE::GUN,	  WEAPON_TYPE::WEAPON_MAGNUM,		"magnumidle"			, "weapon_pickup|weapon_magnum") });
