...
namespace ns_HMGame
{
	EnemyController::EnemyController(ns_fretBuzz::ns_system::GameObject* a_GameObject, ns_fretBuzz::ns_system::GameObject* a_pPlayerUpperGameObj, ns_fretBuzz::ns_system::GameObject* a_pLegsGameObject)
	...
	void EnemyController::manageAI(float a_fDeltaTime)
	{
		...
		PlayerController* l_PlayerInstance = PlayerController::GetInstance();
		...
		ns_fretBuzz::ns_system::Collider2D* l_pRaycastResult = nullptr;

		ns_fretBuzz::ns_system::PhysicsEngine::Raycast(l_pRaycastResult, { l_v3EnemyPostion.x, l_v3EnemyPostion.y }, { l_v3PlayerPostion.x, l_v3PlayerPostion.y});
		...
		PlayerController* m_pPLayerController = l_pRaycastResult->m_GameObject.getComponent<PlayerController>(ns_fretBuzz::ns_system::COMPONENT_TYPE::BEHAVIOUR);
