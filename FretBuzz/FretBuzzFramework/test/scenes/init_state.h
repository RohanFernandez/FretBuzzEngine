...
namespace ns_fretBuzz
{
	...
	public:
			...
			IScene(a_strSceneName)
		{
			...
			ns_system::RectCollider::addToGameObject(*l_pLabelGameObj1, l_RectColliderData);
			...
			ns_system::RectCollider::addToGameObject(*l_pLabelGameObj2, l_RectColliderData);
			...
			ns_system::RectCollider::addToGameObject(*l_pLabelGameObj3, l_RectColliderData);
			...
			ns_system::RectCollider::addToGameObject(*l_pLabelGameObj4, l_RectColliderData);
			...
			ns_system::RectCollider::addToGameObject(*l_pLabelGameObj5, l_RectColliderData);
			...
			ns_graphics::Camera::addToGameObject(*m_pCam, ns_graphics::Viewport::PROJECTION_TYPE::ORTHOGRAPHIC, &l_MainCam, ns_system::LayerMask());
