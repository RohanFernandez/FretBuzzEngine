...
namespace ns_HMGame
{
	class threed_test_scene: public ns_fretBuzz::ns_system::IScene
	{
	private:
		ns_fretBuzz::ns_system::GameObject* m_pThreeDManager = nullptr;
		...
		ns_fretBuzz::ns_graphics::Model* m_pModel = nullptr;
	...
	public:
			...
			: IScene(a_strSceneName) 
		{
			...
			ns_fretBuzz::ns_graphics::Camera* l_pMainCam = m_pManager->addComponent<ns_fretBuzz::ns_graphics::Camera>(ns_fretBuzz::ns_graphics::Viewport::PROJECTION_TYPE::PERSPECTIVE, &l_PerspectiveViewport, ns_fretBuzz::ns_system::LayerMask(ns_fretBuzz::ns_system::LayerMask::PREDEFINED_MASK::EVERYTHING));
			...
			ns_fretBuzz::ns_graphics::Camera* l_pMainCam2 = m_pCam2GameObj->addComponent<ns_fretBuzz::ns_graphics::Camera>(ns_fretBuzz::ns_graphics::Viewport::PROJECTION_TYPE::PERSPECTIVE, &l_PerspectiveViewport2, ns_fretBuzz::ns_system::LayerMask(ns_fretBuzz::ns_system::LayerMask::PREDEFINED_MASK::EVERYTHING));
			...
			m_pLightCube1 = new light_cube(*m_pManager, "Light1", {0.0f, 0.0f, 0.0f}, ns_fretBuzz::ns_graphics::Light::LIGHT_TYPE::SPOT, 1.0f);
			m_pLightCube2 = new light_cube(m_refRootGameObject, "Light2", { 1.0f, 3.0f, 1.0f }, ns_fretBuzz::ns_graphics::Light::LIGHT_TYPE::POINT);
			m_pLightCube3 = new light_cube(m_refRootGameObject, "Light3", { 1.0f, 6.0f, 2.0f }, ns_fretBuzz::ns_graphics::Light::LIGHT_TYPE::POINT);
			m_pLightCube4 = new light_cube(m_refRootGameObject, "Light4", { 1.0f, 9.0f, 3.0f }, ns_fretBuzz::ns_graphics::Light::LIGHT_TYPE::POINT);
			m_pLightCube5 = new light_cube(m_refRootGameObject, "Light5", { 1.0f, 12.0f, 4.0f }, ns_fretBuzz::ns_graphics::Light::LIGHT_TYPE::POINT);
