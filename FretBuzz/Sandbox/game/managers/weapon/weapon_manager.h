...
{
	class WeaponData;
	class WeaponManager : public FRETBUZZ::Behaviour
	{
	private:
		static WeaponManager* s_pInstance;
		std::map<WEAPON_TYPE, WeaponData> m_WeaponMap;

		FRETBUZZ::GameObjectPool<PrefabWeapon> m_WeaponPool;
		FRETBUZZ::GameObjectPool<PrefabBullet> m_BulletPool;

	protected:
		virtual ~WeaponManager();

	public:
		WeaponManager(FRETBUZZ::GameObject* a_GameObject);
