...
namespace ns_HMGame
{
		...
		m_BulletPool()
	{
		...
		m_WeaponMap.insert({ WEAPON_TYPE::WEAPON_M16,			WeaponData(WeaponData::WEAPON_ATTACK_TYPE::GUN,	  WEAPON_TYPE::WEAPON_M16,			"m16idle"				, "weapon_pickup|weapon_M16"			,"weapon_pickup|bullet_m16" ,		"FireM16") });
		...
		m_WeaponMap.insert({ WEAPON_TYPE::WEAPON_DOUBLE_BARREL, WeaponData(WeaponData::WEAPON_ATTACK_TYPE::GUN,   WEAPON_TYPE::WEAPON_DOUBLE_BARREL,  "doublebarrelidle"	, "weapon_pickup|weapon_doublebarrel"	,"weapon_pickup|bullet_shotgun", "FireDoubleBarrell" ) });
